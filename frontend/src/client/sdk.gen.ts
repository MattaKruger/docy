 ...
 */
export const readChatsApiV1ChatV2ChatsGet = <ThrowOnError extends boolean = false>(options?: Options<ReadChatsApiV1ChatV2ChatsGetData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<ReadChatsApiV1ChatV2ChatsGetResponse, ReadChatsApiV1ChatV2ChatsGetError, ThrowOnError>({
 ...
 * Create a new chat.
 */
export const createChatApiV1ChatV2ChatsPost = <ThrowOnError extends boolean = false>(options: Options<CreateChatApiV1ChatV2ChatsPostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<CreateChatApiV1ChatV2ChatsPostResponse, CreateChatApiV1ChatV2ChatsPostError, ThrowOnError>({
        url: '/api/v1/chat_v2/chats/',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 */
export const readChatApiV1ChatV2ChatsChatIdGet = <ThrowOnError extends boolean = false>(options: Options<ReadChatApiV1ChatV2ChatsChatIdGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ReadChatApiV1ChatV2ChatsChatIdGetResponse, ReadChatApiV1ChatV2ChatsChatIdGetError, ThrowOnError>({
 ...
 */
export const readMessagesForChatApiV1ChatV2ChatsChatIdMessagesGet = <ThrowOnError extends boolean = false>(options: Options<ReadMessagesForChatApiV1ChatV2ChatsChatIdMessagesGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ReadMessagesForChatApiV1ChatV2ChatsChatIdMessagesGetResponse, ReadMessagesForChatApiV1ChatV2ChatsChatIdMessagesGetError, ThrowOnError>({
 ...
 */
export const createMessageForChatApiV1ChatV2ChatsChatIdMessagesPost = <ThrowOnError extends boolean = false>(options: Options<CreateMessageForChatApiV1ChatV2ChatsChatIdMessagesPostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<CreateMessageForChatApiV1ChatV2ChatsChatIdMessagesPostResponse, CreateMessageForChatApiV1ChatV2ChatsChatIdMessagesPostError, ThrowOnError>({
        url: '/api/v1/chat_v2/chats/{chat_id}/messages/',
        ...options,
        headers: {
            'Content-Type': 'application/json',
